...
<body>
<img src="chess_thumbnail.jpeg" height="90px" style="position:relative; float:left; left:5px; top:5px; z-index:1">
		<img id="rook" src="rook.gif" height="75px">
		<div class="menu">
			<ul>
		...
		<div class="cuboid">
			<div id="onehome">
				<div id="live">
					...
					<h2><center>Live Score</h2>
					<h3><center>Live Score</h3>
				</div>
				<div id="update">
					<h1><center>Updates</h1>
					<h2><center>Updates</h2>
					<h3><center>Updates</h3>
				</div>
			</div>
			<div id="twogall">
				<div id="showcase">
			...
			<div id="threetm" style="overflow:auto">
				<table style="background:white; position:relative; left:30px;">
					<tr>
						<td>
							<div>
							<img src="mem/mem1.jpg" width="100px" height="100px" style="float:left; margin:20px">
							<p style="float:right;">
