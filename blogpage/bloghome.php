                ...
                <div class="col-lg-12 text-center">
                    <div id="carousel-example-generic" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item">
                                <img class="img-responsive img-full" src="img/badminton_1.jpg" alt="">
                            </div>
                            <div class="item">
                                <img class="img-responsive img-full" src="img/h3.JPG" alt="">
                            </div>
                        </div>
...
<div id="badcover" style="position:relative; background:white; z-index:7; display:none;">
            <h4 onclick="badclose()" style="cursor:pointer;">CLOSE X</h4>
 <div class="row1">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">Badminton
                        <strong>blog</strong>
                    </h2>
                    <hr>
                </div>
    <?php
    $content = $general->dashboard(4);
    foreach($content as $reach)
        {       
...
<div id="chesscover" style="position:relative; background:white; z-index:7; display:none;">
            <h4 onclick="chessclose()" style="cursor:pointer;">CLOSE X</h4>
 <div class="row1">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">CHESS
                        <strong>blog</strong>
                    </h2>
                    <hr>
                </div>
    <?php
    $content = $general->dashboard(8);
    foreach($content as $reach)
        {       
...
<div id="swimmingcover" style="position:relative; background:white; z-index:7; display:none;">
            <h4 onclick="sclose()" style="cursor:pointer;">CLOSE X</h4>
 <div class="row1">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">SWIMMING
                        <strong>blog</strong>
                    </h2>
                    <hr>
                </div>
            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">
                        <a onclick="footshow(2)" style="cursor:pointer; text-align:center;"><strong>FootBall Blog</strong></a><!--Enter as covershow($id)-->
                    </h2>
                    <hr>
...
<div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">
                        <a onclick="handshow(2)" style="cursor:pointer; text-align:center;"><strong>HandBall Blog</strong></a>
                    </h2>
                    <hr>
...
<div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">
                        <a onclick="badmintonshow()" style="cursor:pointer; text-align:center;"><strong>Badminton Blog</strong></a>
                    </h2>
                    <hr>
                    <img class="img-responsive img-border img-left" src="img/Badminton3.jpg" alt="">
                    <hr class="visible-xs">
                    <p></p>
                    <p></p>
                    <p></p>
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">
                        <a onclick="chessshow()" style="cursor:pointer; text-align:center;"><strong>Chess Blog</strong></a>
                    </h2>
                    <hr>
                    <img class="img-responsive img-border img-left" src="img/h1.jpg" alt="">
                    <hr class="visible-xs">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">
                        <a onclick="swimmingshow()" style="cursor:pointer; text-align:center;"><strong>Swimming Blog</strong></a>
                    </h2>
                    <hr>
                    <img class="img-responsive img-border img-left" src="img/gal8.jpg" alt="">
                    <hr class="visible-xs">
                    <p></p>
                    <p></p>
                    <p></p>
 ...
 <!-- jQuery -->
    ...
    <script>
	function footshow(id)// covershow($id)
{
...
function handshow($id)// covershow($id)
{
    
	$("#handballcover").show();
    $("#handballcover").html($id);
	$(".row").hide();
}
...
function badmintonshow()// covershow($id)
{
...
function chessshow()// covershow($id)
{
...
function swimmingshow()// covershow($id)
{
